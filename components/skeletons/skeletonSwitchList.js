function SkeletonSwitchList() {
    ...
    return (
        <div className="flex flex-row flex-wrap justify-center">
            {n.map((n) => (
                <div className="flex flex-row justify-between w-80 h-28 m-4 border-r-8 rounded-md cursor-pointer animate-pulse shadow-lg" style={{borderColor: "var(--primary-color)"}}>
