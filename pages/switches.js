...
const Switches = () => {
    ...
    return (
        <Layout>
          <div className="flex flex-col xl:w-3/5 w-4/5">
            ...
            {data.map((s) => (
              <Link href={`/switches/${s.slug}`} key={s.slug} id={s.slug}>
                  <div className="flex flex-row justify-between w-80 h-28 border-r-8 rounded-md cursor-pointer" style={{borderColor: "var(--primary-color)"}}>
